...
export const ANATOMICAL_LIMITS: Partial<Record<HumanoidBoneName, JointLimit>> = {
  ...
  // Wrist / Hand: Extended anatomical range of motion for floor pushups, planks, and martial strikes
  LeftHand: {
    minPitch: THREE.MathUtils.degToRad(-90),
    maxPitch: THREE.MathUtils.degToRad(95),
    minYaw: THREE.MathUtils.degToRad(-30),
    maxYaw: THREE.MathUtils.degToRad(30),
    minRoll: THREE.MathUtils.degToRad(-35),
    maxRoll: THREE.MathUtils.degToRad(35),
  },
  RightHand: {
    minPitch: THREE.MathUtils.degToRad(-90),
    maxPitch: THREE.MathUtils.degToRad(95),
