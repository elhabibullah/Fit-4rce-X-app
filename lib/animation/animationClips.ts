...
// 2. LUNGE: Authentic, fluid, human alternating lunges (rear toe on floor, front heel on floor, zero kicking in air)
const LUNGE_CLIP = new HumanoidMotionClip('lunge', 'Lunge', 3.6, [
  // 0.00: Standing tall, both feet together flat on the floor
  {
    time: 0.0,
    hipsOffset: [0, 0, 0],
    bones: {
      ...
      LeftUpLeg: { pitch: 0, yaw: 0, roll: 0.03 },
      RightUpLeg: { pitch: 0, yaw: 0, roll: 0.03 },
  ...
  // 0.25: Step back with Left leg - hips descend, rear knee hovers 5cm off floor with toes on floor, front heel flat
  {
    time: 0.25,
    hipsOffset: [0, -0.38, 0],
    bones: {
      Spine: { pitch: 0.04, yaw: 0, roll: 0 },
      RightUpLeg: { pitch: 0.95, yaw: 0, roll: 0.02 }, // Front thigh horizontal
      RightLeg: { pitch: 1.15, yaw: 0, roll: 0 },       // Front knee 90 deg, shin vertical
      RightFoot: { pitch: 0.20, yaw: 0, roll: 0 },       // Front foot 100% flat on floor, heel solid
      LeftUpLeg: { pitch: 0.05, yaw: 0, roll: 0.03 },    // Rear thigh vertical down to knee
      LeftLeg: { pitch: 1.35, yaw: 0, roll: 0 },        // Rear knee 90 deg
      LeftFoot: { pitch: -0.55, yaw: 0, roll: 0 },      // Rear ball of foot and toes firmly on the floor
      LeftArm: { pitch: 0.40, yaw: 0, roll: 0.08 },
      RightArm: { pitch: -0.20, yaw: 0, roll: 0.08 },
    },
  },
  // 0.50: Push through front heel to return smoothly to neutral standing tall
  {
    time: 0.50,
    hipsOffset: [0, 0, 0],
    bones: {
  ...
  // 0.75: Step back with Right leg - hips descend, rear right knee hovers with toes on floor, front left heel flat
  {
    time: 0.75,
    hipsOffset: [0, -0.38, 0],
    bones: {
      Spine: { pitch: 0.04, yaw: 0, roll: 0 },
      LeftUpLeg: { pitch: 0.95, yaw: 0, roll: 0.02 },   // Front thigh horizontal
      LeftLeg: { pitch: 1.15, yaw: 0, roll: 0 },        // Front knee 90 deg, shin vertical
      LeftFoot: { pitch: 0.20, yaw: 0, roll: 0 },       // Front foot 100% flat on floor, heel solid
      RightUpLeg: { pitch: 0.05, yaw: 0, roll: 0.03 },  // Rear thigh vertical down to knee
      RightLeg: { pitch: 1.35, yaw: 0, roll: 0 },       // Rear knee 90 deg
      RightFoot: { pitch: -0.55, yaw: 0, roll: 0 },     // Rear ball of foot and toes firmly on the floor
      RightArm: { pitch: 0.40, yaw: 0, roll: 0.08 },
      LeftArm: { pitch: -0.20, yaw: 0, roll: 0.08 },
    },
  },
  // 1.00: Return to neutral standing tall with both feet together
  {
    time: 1.0,
    hipsOffset: [0, 0, 0],
    bones: {
...
// 3. PUSH-UP: Full floor prone push-up with natural flat toes on floor
const PUSHUP_CLIP = new HumanoidMotionClip('pushup', 'Pushup', 2.4, [
  // 0.00: Top lockout - prone horizontal, arms straight supporting upper body, toes flat on balls of feet
  {
    time: 0.0,
    hipsOffset: [0, 0, 0],
    proneAngle: 1.48,
    bones: {
      ...
      LeftFoot: { pitch: -0.35, yaw: 0, roll: 0 }, // Dorsiflexed: resting naturally on balls of feet
...
// 3B. REVERSE LUNGE: True backwards stepping lunges (rear toe on floor, front heel on floor, zero kicking in air)
const REVERSE_LUNGE_CLIP = new HumanoidMotionClip('reverse_lunge', 'Reverse Lunge', 3.4, [
  ...
  // 0.25: Left leg steps BACKWARDS to floor - hips drop, rear knee hovers with toes on floor, front heel flat
  {
    time: 0.25,
    hipsOffset: [0, -0.38, -0.05],
    bones: {
      Spine: { pitch: 0.04, yaw: 0, roll: 0 },
      RightUpLeg: { pitch: 0.95, yaw: 0, roll: 0.02 }, // Front thigh horizontal
      RightLeg: { pitch: 1.15, yaw: 0, roll: 0 },       // Front knee 90 deg, shin vertical
      RightFoot: { pitch: 0.20, yaw: 0, roll: 0 },       // Front foot 100% flat on floor
      LeftUpLeg: { pitch: 0.05, yaw: 0, roll: 0.03 },    // Rear thigh vertical down
      LeftLeg: { pitch: 1.35, yaw: 0, roll: 0 },        // Rear knee 90 deg
      LeftFoot: { pitch: -0.55, yaw: 0, roll: 0 },      // Ball of rear foot & toes firmly on floor
      LeftArm: { pitch: 0.40, yaw: 0, roll: 0.08 },
      RightArm: { pitch: -0.20, yaw: 0, roll: 0.08 },
    },
  },
  ...
  // 0.75: Right leg steps BACKWARDS to floor - hips drop, rear right knee hovers with toes on floor, front left heel flat
  {
    time: 0.75,
    hipsOffset: [0, -0.38, -0.05],
    bones: {
      Spine: { pitch: 0.04, yaw: 0, roll: 0 },
      LeftUpLeg: { pitch: 0.95, yaw: 0, roll: 0.02 },   // Front left thigh horizontal
      LeftLeg: { pitch: 1.15, yaw: 0, roll: 0 },        // Front knee 90 deg, shin vertical
      LeftFoot: { pitch: 0.20, yaw: 0, roll: 0 },       // Front foot 100% flat on floor
      RightUpLeg: { pitch: 0.05, yaw: 0, roll: 0.03 },  // Rear right leg steps straight back down
      RightLeg: { pitch: 1.35, yaw: 0, roll: 0 },       // Rear knee 90 deg
      RightFoot: { pitch: -0.55, yaw: 0, roll: 0 },     // Ball of rear foot planted firmly on floor
      RightArm: { pitch: 0.40, yaw: 0, roll: 0.08 },
      LeftArm: { pitch: -0.20, yaw: 0, roll: 0.08 },
    },
  },
...
// 3C. CRUNCH: Supine abdominal curling (couché sur le dos, dos au sol, bras symétriques)
const CRUNCH_CLIP = new HumanoidMotionClip('crunch', 'Crunch (Abdos)', 2.4, [
  // 0.00: Supine on floor - back and hips resting flush on podium, knees bent, arms straight along thighs
  {
    time: 0.0,
    hipsOffset: [0, 0, 0],
    proneAngle: -1.57, // Face UP, back flat on the floor (dos au sol)
    groundOffsetZ: 0.0,
    bones: {
      Spine: { pitch: 0, yaw: 0, roll: 0 },
      Spine1: { pitch: 0, yaw: 0, roll: 0 },
      Head: { pitch: 0.05, yaw: 0, roll: 0 },
      LeftArm: { pitch: 0.65, yaw: 0, roll: 0.06 }, // Symmetrical arms reaching cleanly along thighs
      RightArm: { pitch: 0.65, yaw: 0, roll: 0.06 },
      ...
      LeftUpLeg: { pitch: 0.95, yaw: 0.04, roll: 0.04 }, // Knees bent ~90 deg, feet flat near hips
      RightUpLeg: { pitch: 0.95, yaw: -0.04, roll: 0.04 },
  ...
  // 0.45: Concentric curl - thoracic spine flexes up, curling shoulders smoothly off the floor
  {
    time: 0.45,
    hipsOffset: [0, 0, 0],
    proneAngle: -1.57,
    groundOffsetZ: 0.0,
    bones: {
      Spine: { pitch: 0.36, yaw: 0, roll: 0 }, // Strict sagittal abdominal flexion
      Spine1: { pitch: 0.24, yaw: 0, roll: 0 },
      Head: { pitch: 0.20, yaw: 0, roll: 0 },
      LeftArm: { pitch: 0.82, yaw: 0, roll: 0.06 }, // Arms glide forward toward knees
      RightArm: { pitch: 0.82, yaw: 0, roll: 0.06 },
      LeftForeArm: { pitch: 0.10, yaw: 0, roll: 0 },
      RightForeArm: { pitch: 0.10, yaw: 0, roll: 0 },
      LeftHand: { pitch: 0.05, yaw: 0, roll: 0 },
      RightHand: { pitch: 0.05, yaw: 0, roll: 0 },
      LeftUpLeg: { pitch: 0.95, yaw: 0.04, roll: 0.04 },
      RightUpLeg: { pitch: 0.95, yaw: -0.04, roll: 0.04 },
      LeftLeg: { pitch: 1.50, yaw: 0, roll: 0 },
      RightLeg: { pitch: 1.50, yaw: 0, roll: 0 },
      LeftFoot: { pitch: 0.35, yaw: 0, roll: 0 },
  ...
  // 0.60: Squeeze abdominal peak - hold contraction
  {
    time: 0.60,
    hipsOffset: [0, 0, 0],
    proneAngle: -1.57,
    groundOffsetZ: 0.0,
    bones: {
      Spine: { pitch: 0.36, yaw: 0, roll: 0 },
      Spine1: { pitch: 0.24, yaw: 0, roll: 0 },
      Head: { pitch: 0.20, yaw: 0, roll: 0 },
      LeftArm: { pitch: 0.82, yaw: 0, roll: 0.06 },
      RightArm: { pitch: 0.82, yaw: 0, roll: 0.06 },
      LeftForeArm: { pitch: 0.10, yaw: 0, roll: 0 },
      RightForeArm: { pitch: 0.10, yaw: 0, roll: 0 },
      LeftHand: { pitch: 0.05, yaw: 0, roll: 0 },
  ...
  // 1.00: Controlled descent back flat on the floor
  {
    ...
    bones: {
      ...
      Spine1: { pitch: 0, yaw: 0, roll: 0 },
      Head: { pitch: 0.05, yaw: 0, roll: 0 },
      LeftArm: { pitch: 0.65, yaw: 0, roll: 0.06 },
      RightArm: { pitch: 0.65, yaw: 0, roll: 0.06 },
      LeftForeArm: { pitch: 0.10, yaw: 0, roll: 0 },
      RightForeArm: { pitch: 0.10, yaw: 0, roll: 0 },
      LeftHand: { pitch: 0.05, yaw: 0, roll: 0 },
...
// 3D. GLUTE BRIDGE: Supine glute bridge (dos et épaules au sol, bassin s'élève en pont sans rebond)
const GLUTE_BRIDGE_CLIP = new HumanoidMotionClip('glute_bridge', 'Glute Bridge (Pont Fessier)', 2.8, [
  // 0.00: Starting pose - back on floor, knees bent, arms straight alongside body on the floor
  {
    ...
    bones: {
      ...
      // Bras symétriques le long du corps au sol
      LeftArm: { pitch: 0.05, yaw: 0, roll: 0.12 },
      RightArm: { pitch: 0.05, yaw: 0, roll: 0.12 },
      LeftForeArm: { pitch: 0, yaw: 0, roll: 0 },
      RightForeArm: { pitch: 0, yaw: 0, roll: 0 },
      LeftHand: { pitch: 0, yaw: 0, roll: 0 },
      RightHand: { pitch: 0, yaw: 0, roll: 0 },
  ...
  // 0.50: Full bridge extension - hips elevate into straight bridge, upper back & shoulders remain planted on floor!
  {
    time: 0.50,
    hipsOffset: [0, 0.20, 0], // Pelvis elevated smoothly in bridge
    proneAngle: -1.57,
    groundOffsetZ: 0.0,
    bones: {
      Spine: { pitch: -0.45, yaw: 0, roll: 0 }, // Back extends so upper back and head remain anchored to floor!
      Spine1: { pitch: -0.20, yaw: 0, roll: 0 },
  ...
  // 0.65: Squeeze glutes at top of bridge
  {
    time: 0.65,
    hipsOffset: [0, 0.20, 0],
    proneAngle: -1.57,
...
// 11. IDLE: Natural, centered, balanced breathing posture (zero side stitch, zero tilt)
const IDLE_CLIP = new HumanoidMotionClip('idle', 'Idle', 3.2, [
  ...
  },
  {
    ...
    bones: {
      ...
      LeftArm: { pitch: 0.10, yaw: 0, roll: 0.09 },
      RightArm: { pitch: 0.10, yaw: 0, roll: 0.09 },
      LeftForeArm: { pitch: 0.15, yaw: 0, roll: 0 },
      RightForeArm: { pitch: 0.15, yaw: 0, roll: 0 },
      LeftUpLeg: { pitch: 0, yaw: 0, roll: 0.03 },
      RightUpLeg: { pitch: 0, yaw: 0, roll: 0.03 },
...
const JUMP_CLIP = new HumanoidMotionClip('jump', 'Jumping Jacks', 1.1, [
  ...
  // 1.00: Soft landing, feet together, arms at sides
  {
    time: 1.0,
    hipsOffset: [0, 0, 0],
    bones: {
...
// 15. BURPEE: Full 6-phase military burpee (Stand -> Crouch -> Plank -> Full Push-up -> Crouch -> Explosive Jump -> Land)
const BURPEE_CLIP = new HumanoidMotionClip('burpee', 'Burpee', 3.2, [
  // Phase 1 (0.00): Standing tall ready stance
  {
    time: 0.0,
    hipsOffset: [0, 0, 0],
    proneAngle: 0,
  ...
  // Phase 2 (0.18): Drop down into deep crouch squat, plant palms toward floor
  {
    time: 0.18,
    hipsOffset: [0, -0.40, 0.10],
    proneAngle: 0.20,
    bones: {
      Spine: { pitch: 0.45, yaw: 0, roll: 0 },
  ...
  // Phase 3 (0.36): Kick legs back into full horizontal plank on floor
  {
    time: 0.36,
    hipsOffset: [0, -0.05, 0],
    proneAngle: 1.48,
    bones: {
      ...
      LeftUpLeg: { pitch: 0, yaw: 0, roll: 0.05 },
      RightUpLeg: { pitch: 0, yaw: 0, roll: 0.05 },
      LeftFoot: { pitch: -0.35, yaw: 0, roll: 0 }, // Feet dorsiflexed on balls of feet
      RightFoot: { pitch: -0.35, yaw: 0, roll: 0 },
    },
  },
  // Phase 4 (0.50): Full chest-to-floor push-up dip and press lockout
  {
    time: 0.50,
    hipsOffset: [0, -0.15, 0],
    proneAngle: 1.48,
  ...
  // Phase 5 (0.64): Push back up to plank lockout
  {
    time: 0.64,
    hipsOffset: [0, -0.05, 0],
    proneAngle: 1.48,
  ...
  // Phase 6 (0.76): Snap feet forward under hips into deep crouch
  {
    time: 0.76,
    hipsOffset: [0, -0.40, 0.10],
    proneAngle: 0.20,
  ...
  // Phase 7 (0.88): Explosive vertical jump! High leap into the air, arms reach high overhead
  {
    time: 0.88,
    hipsOffset: [0, 0.35, 0],
    proneAngle: 0,
    bones: {
      ...
      LeftLeg: { pitch: 0.05, yaw: 0, roll: 0 },
      RightLeg: { pitch: 0.05, yaw: 0, roll: 0 },
      LeftFoot: { pitch: -0.35, yaw: 0, roll: 0 }, // Pointed toes in flight
      RightFoot: { pitch: -0.35, yaw: 0, roll: 0 },
      LeftArm: { pitch: 0.08, yaw: 0, roll: 2.70 }, // Overhead vertical jump reach
      RightArm: { pitch: 0.08, yaw: 0, roll: 2.70 },
      LeftForeArm: { pitch: 0.05, yaw: 0, roll: 0 },
      RightForeArm: { pitch: 0.05, yaw: 0, roll: 0 },
    },
  },
  // Phase 8 (1.00): Soft landing & return to ready standing stance
  {
    time: 1.0,
    hipsOffset: [0, 0, 0],
    proneAngle: 0,
